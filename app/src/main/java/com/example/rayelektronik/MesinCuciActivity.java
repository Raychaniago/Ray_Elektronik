package com.example.rayelektronik;
...
public class MesinCuciActivity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mesin_cuci);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btndeskripsibaju1 || v.getId() == R.id.ivbaju1) {
            ...
            baju1.setGambar("mesincuci1");

            Intent intent = new Intent(MesinCuciActivity.this, ActivityDetail.class);
