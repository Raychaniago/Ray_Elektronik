...
public class TvActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btndeskripsisepatu1 || v.getId() == R.id.ivsepatu1) {
            ...
            sepatu1.setGambar("tv1");

            Intent intent = new Intent(TvActivity.this, ActivityDetail.class);
