...
public class KulkasActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btndeskripsikacamata1 || v.getId() == R.id.ivkacamata1) {
            ...
            kacamata1.setGambar("kulkas1");

            Intent intent = new Intent(KulkasActivity.this, ActivityDetail.class);
